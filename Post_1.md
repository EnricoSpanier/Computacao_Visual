...
Ao ver o nome da matéria na grade confesso que dei uma leve desanimada pela impressão de ser uma materia focada em front-end, uma área da computação que não me agrada nem me atrai muito. Tinha praticamente certeza que focariamos em coisas como Design iterativo de telas, dar movimento a sites e criar uma experiencia diferente de rolagem de tela fazendo transições suaves que mantivessem o usuário "entretido" enquanto navega no site.
